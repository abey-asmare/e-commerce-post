...
// import { CommentType, useCommentStore, useProductStore } from "../../store/commentStore";
...
//   const { likeReview, likeSubComment } = useProductStore((state) => ({
//     likeReview: state.likeReview,
//     likeSubComment: state.likeSubComment,
//   }));
...
//             <Comment key={subComment.id} {...subComment} isSubComment={true} />
//           ))}
//         </div>
//       )}
//     </div>
